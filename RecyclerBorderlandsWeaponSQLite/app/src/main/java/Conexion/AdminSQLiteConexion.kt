...
class AdminSQLiteConexion (context: Context, name: String, factory: SQLiteDatabase.CursorFactory?, version: Int) : SQLiteOpenHelper(context, name, factory, version) {
    ...
    override fun onCreate(db: SQLiteDatabase) {
        Log.e("JVVM","Paso por OnCreate del AdminSQLLite")
        /*
        ...
        */
        db.execSQL("create table armas(nombre text primary key, fabricante text, imagen text, tipo text, rareza text, gatillo text, canion text, elemento text, complemento text)")
    }
