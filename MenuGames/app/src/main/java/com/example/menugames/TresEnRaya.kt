...
import com.example.menugames.databinding.ActivityTresEnRayaBinding

class TresEnRaya : AppCompatActivity() {
    lateinit var binding: ActivityTresEnRayaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTresEnRayaBinding.inflate(layoutInflater)
        ...
        binding.toolbarTresEnRaya.title = "Jugador "+intent.getStringExtra("nombre")

        setSupportActionBar(binding.toolbarTresEnRaya)
        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        binding.toolbarTresEnRaya.setNavigationOnClickListener {
            finish()
        }
